...
As ants move through the network of servers they deposit pheromones. At the same time the pheromone decays at the servers at a constant rate. For the purpose of controlling the number of servers in the cloud the pheromone level in the network is used as a proxy for how loaded the entire cloud of servers is and used to decide when to add or remove servers. 
