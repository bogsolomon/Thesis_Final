...
The ACO model for SLA breach prediction is composed of three components: Ants - ants are simple agents which traverse the network of servers and deposit pheromone at the servers based on a mathematical model; Pheromone levels - each server has it's own pheromone level which is increased by ants visiting the server and decays periodically. Pheromones are a proxy of how overloaded a single server is; Mathematical model - this is the model which converts the fuzzy model result of each server into a pheromone value. The mathematical model also represents when an SLA breach is predicted.
...
The pheromone level at a single node is defined based on the previous section as:
...
The house hunting algorithm is performed in rounds and ants can be in one of four states: Search - This is the initial state of ants which search for a new nest; Active - The ant is committed to a good nest and tries to recruit other ants to it; Passive - The ant is committed to a bad nest and is waiting to be recruited; Final - A single nest remains so all ants go to it and that is the solution.
...
\begin{figure}
	\centering
		\includegraphics[width=0.50\columnwidth]{results/sim1/sim1-basestats.png}
	\caption{Simulation - Low workload: Simple}
	\label{fig:sim1-basestats}
\end{figure}

\begin{figure}
	\centering
		\includegraphics[width=0.50\columnwidth]{results/sim1/sim1-antSimplestats.png}
	\caption{Simulation - Low workload: Simple ant}
	\label{fig:sim1-antSimplestats}
\end{figure}

\begin{figure}
	\centering
		\includegraphics[width=0.50\columnwidth]{results/sim1/sim1-antHHstats.png}
	\caption{Simulation - Low workload: House hunt}
...
Simple & 755 & 762 & 7140 & 88423 & 3048 & 1080 \\
Simple ant & 128 & 132 & 2796 & 40104 & 16008 & 7260 \\
House hunt & 223 & 339 & 16656 & 53352 & 11184 & 5904 \\
\end{tabu}
\end{table}
...
\taburowcolors 2{Gray!20..LimeGreen!50}
Simple & 28.8 & 118.6 & 3.35 \\
Simple ant & 20.5 & 75.3 & 3.49 \\
House hunt & 115.4 & 574.3 & 1.95 \\
\end{tabu}
\end{table}
...
\begin{figure}
	\centering
		\includegraphics[width=0.50\columnwidth]{results/sim2/sim2-basestats.png}
	\caption{Simulation - High workload: Simple}
	\label{fig:sim2-basestats}
\end{figure}

\begin{figure}
	\centering
		\includegraphics[width=0.50\columnwidth]{results/sim2/sim2-antSimplestats.png}
	\caption{Simulation - High workload: Simple ant}
	\label{fig:sim2-antSimplestats}
\end{figure}

\begin{figure}
	\centering
		\includegraphics[width=0.50\columnwidth]{results/sim2/sim2-antHHstats.png}
	\caption{Simulation - High workload: House hunt}
...
Scaling Algorithm & Scale Up Count & Scale Down Count & Over Provisioned - 20\% (s) & Over Provisioned - 40\% (s) & High usage - 70\% (s) & High usage - 80\% (s) \\
\taburowcolors 2{Gray!20..LimeGreen!50}
Simple & 717 & 693 & 26255 & 50503 & 8952 & 231 \\
Simple ant & 661 & 656 & 22241 & 42750 & 85873 & 62593 \\
House hunt & 332 & 253 & 768 & 32643 & 35419 & 18631 \\
\end{tabu}
\end{table}
...
\taburowcolors 2{Gray!20..LimeGreen!50}
Simple & 0 & 14.1 & 46.9 \\
Simple ant & 1.1 & 15.3 & 37.7 \\
House hunt & 1.1 & 28.4 & 40.9 \\
\end{tabu}
\end{table}
...
\begin{figure}
	\centering
		\includegraphics[width=0.50\columnwidth]{results/sim3/sim3-basestats.png}
	\caption{Simulation - Very high workload: Simple}
	\label{fig:sim3-basestats}
\end{figure}

\begin{figure}
	\centering
		\includegraphics[width=0.50\columnwidth]{results/sim3/sim3-antSimplestats.png}
	\caption{Simulation - Very high workload: Simple ant}
	\label{fig:sim3-antSimplestats}
\end{figure}

\begin{figure}
	\centering
		\includegraphics[width=0.50\columnwidth]{results/sim3/sim3-antHHstats.png}
	\caption{Simulation - Very high workload: House hunt}
...
Scaling Algorithm & Scale Up Count & Scale Down Count & Over Provisioned - 20\% (s) & Over Provisioned - 40\% (s) & High usage - 70\% (s) & High usage - 80\% (s) \\
\taburowcolors 2{Gray!20..LimeGreen!50}
Simple & 1004 & 833 & 46339 & 86035 & 42768 & 20604 \\
Simple ant & 726 & 679 & 16412 & 54641 & 83245 & 76837 \\
House hunt & 354 & 287 & 1956 & 33864 & 32151 & 22080 \\
\end{tabu}
\end{table}
...
\taburowcolors 2{Gray!20..LimeGreen!50}
Simple & 1 & 27.6 & 70.6 \\
Simple ant & 3.9 & 22.5 & 43.2 \\
House hunt & 10.7 & 192 & 42.8 \\
\end{tabu}
\end{table}
